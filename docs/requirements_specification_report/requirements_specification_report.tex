...
\begin{figure}[p!]
  ...
  \centering
  \includegraphics[width=0.95\linewidth]{class_diagram.pdf}
...
\begin{figure}[p!]
  ...
  \centering
  \includegraphics[width=\linewidth]{add_edit_remove_grade_entries_sequence_diagram.pdf}
...
\begin{figure}[p!]
  ...
  \centering
  \includegraphics[width=\linewidth]{register_activity_diagram.pdf}
...
\begin{figure}[p!]
  ...
  \centering
  \includegraphics[width=\linewidth]{login_activity_diagram.pdf}
